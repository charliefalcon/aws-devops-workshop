...
# Write a function named `home` which returns 'Welcome to the Charlie Falcon's Bookstore API Service',
# and assign to the static route of ('/')
@app.route('/')
def home():
    return "Welcome to Charlie Falcon's Bookstore API Service"
